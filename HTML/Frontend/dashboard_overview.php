			...
			<div class="top-header">
				...
				<div class="header_right">
					<ul>
						...
						<li>
							<a href="dashboard_my_wishlist.php" class="option_links" title="Wishlist"><i
						...
						<li class="ui dropdown">
							...
							<div class="menu dropdown_account">
								...
								<a href="dashboard_overview.php" class="item channel_item"><i
										class="uil uil-apps icon__1"></i>Perfil</a>
								<a href="dashboard_my_orders.php" class="item channel_item"><i
										class="uil uil-box icon__1"></i>Ordens de compra</a>
								<a href="dashboard_my_wishlist.php" class="item channel_item"><i
										class="uil uil-heart icon__1"></i>Lista de desejos</a>
								<a href="dashboard_my_wallet.php" class="item channel_item"><i
										class="uil uil-usd-circle icon__1"></i>Carteira</a>
								<a href="dashboard_my_addresses.php" class="item channel_item"><i
										class="uil uil-location-point icon__1"></i>Endereço</a>
								<a href="offers.html" class="item channel_item"><i
										class="uil uil-gift icon__1"></i>Ofertas</a>
								<a href="faq.html" class="item channel_item"><i
										class="uil uil-info-circle icon__1"></i>Perguntas frequentes</a>
								<a href="/mercado-paid-egua/HTML/frontend/php/logout.php" class="item channel_item"><i
										class="uil uil-lock-alt icon__1"></i>Sair</a>
							</div>
						</li>
					</ul>
				</div>
			...
			<div class="sub-header">
				<div class="ui dropdown">
					<a href="#" class="category_drop hover-btn" data-toggle="modal" data-target="#category_model"
						title="Categories"><i class="uil uil-apps"></i><span class="cate__icon">Selecionar
							Categoria</span></a>
				</div>
					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse d-flex flex-column flex-lg-row flex-xl-row justify-content-lg-end bg-dark1 p-3 p-lg-0 mt1-5 mt-lg-0 mobileMenu"
							...
							<ul class="navbar-nav main_nav align-self-stretch">
								<li class="nav-item"><a href="index.php" class="nav-link active" title="Home">Home</a>
								</li>
								<li class="nav-item"><a href="shop_grid.html" class="nav-link new_item"
										title="New Products">Novos Produtos</a></li>
								<li class="nav-item"><a href="shop_grid.html" class="nav-link"
										title="Featured Products">Produtos em Destaques</a></li>
								<li class="nav-item">
									<div class="ui icon top left dropdown nav__menu">
										<a class="nav-link" title="Pages">Mais <i class="uil uil-angle-down"></i></a>
										<div class="menu dropdown_page">
											<a href="dashboard_overview.html"
												class="item channel_item page__links">Conta</a>
											<a href="about_us.html" class="item channel_item page__links">Sobre nós</a>
											<a href="shop_grid.html" class="item channel_item page__links">Rede de
												lojas</a>
											<a href="single_product_view.html"
												class="item channel_item page__links">Visualizar um Produto</a>
											<a href="checkout.html" class="item channel_item page__links">Finalizar
												Pedido</a>
											<a href="request_product.html" class="item channel_item page__links">Pedidos
												de Produto</a>
											<a href="order_placed.html" class="item channel_item page__links">Pedidos
												Finalizados</a>
											<a href="bill.html" class="item channel_item page__links">Imprimir
												Pedidos</a>
											<a href="sign_in.html" class="item channel_item page__links">Entrar</a>
											<a href="sign_up.html"
												class="item channel_item page__links">Cadastrar-se</a>
											<a href="forgot_password.html"
												class="item channel_item page__links">Esqueceu sua senha?</a>
											<a href="contact_us.html" class="item channel_item page__links">Fale
												Conosco</a>
										</div>
									</div>
								</li>
								<li class="nav-item">
									<div class="ui icon top left dropdown nav__menu">
										...
										<div class="menu dropdown_page">
											...
											<a href="blog_no_sidebar.html" class="item channel_item page__links">Dois
												Sem Barra Lateral</a>
											<a href="blog_left_sidebar.html" class="item channel_item page__links">Com
												Barra Lateral Esquerda</a>
											<a href="blog_right_sidebar.html" class="item channel_item page__links">Com
												Barra Lateral Direita</a>
											<a href="blog_detail_view.html"
												class="item channel_item page__links">Visualização de detalhes</a>
											<a href="blog_left_sidebar_single_view.html"
												class="item channel_item page__links">Detalhes Com Barra Lateral</a>
										</div>
									</div>
								</li>
								<li class="nav-item"><a href="contact_us.html" class="nav-link" title="Contact">Fale
										conosco</a></li>
							</ul>
						</div>
					</div>
				...
				<div class="header_cart order-1">
					<a href="#" class="cart__btn hover-btn pull-bs-canvas-left" title="Cart"><i
							class="uil uil-shopping-cart-alt"></i><span>Carrinho</span><ins>2</ins><i
