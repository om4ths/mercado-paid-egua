<?php
    ...
    include('conexao.php');
        ...
        $query = "INSERT INTO produtos (pro_nome, pro_desc, pro_cat, pro_valor)
                VALUES ('$pro_nome', '$pro_desc', '$pro_cat', '$pro_valor')";
        ...
        /*if($insert){
            ...
            header("Location: /mercado-paid-egua/HTML/admin/product_view.php");
            die();
          }else{
